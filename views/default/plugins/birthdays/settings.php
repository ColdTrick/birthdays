...
$output_format .= elgg_view("input/radio", array(
	"name" => "params[output_format]",
	"options" => $output_format_options,
	"value" => birthdays_get_output_date_format()
));
...
$other .= "&nbsp;" . elgg_view("input/dropdown", array(
	"name" => "params[limit_upcoming]",
	"options_values" => $yesno_options,
	"value" => $plugin->limit_upcoming
));
$other .= "</div>";
